...
import editorPackage.AdvancedTextEditor;
import editorPackage.PrintTextEditor;
    ...
    public static void test(TextEditor editor) {
        ...
        if (code == 1) {
            ...
            try {
                ...
                append.invoke(editor, appendWord);
                System.out.println("After append: " + editor.getText());
                System.out.print("Enter number of letters to delete: ");
                int deleteVal= scanner.nextInt();
                delete.invoke(editor, deleteVal);
                System.out.println("After delete: " + editor.getText());
                System.out.println("SUCCESS");
            } catch (Exception e) {
                System.out.println("FAILED");
