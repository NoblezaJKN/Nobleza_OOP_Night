...
package noblezacalculator;


public class NoblezaCalculator extends javax.swing.JFrame {

    
   public NoblezaCalculator() {
    initComponents();
  }
 ...
 public void enable()
    ...
    private void initComponents() {
        ...
        jButton2.setForeground(new java.awt.Color(51, 255, 102));
        jButton2.setText("×");
        ...
        jButton13.setForeground(new java.awt.Color(51, 255, 102));
        jButton13.setText("÷");
        ...
        jButton15.setForeground(new java.awt.Color(51, 255, 102));
        jButton15.setText("-");
        ...
        jButton19.setForeground(new java.awt.Color(51, 255, 102));
        ...
        jButton20.setForeground(new java.awt.Color(51, 255, 102));
        jButton20.setText("+");
        ...
        jButton22.setForeground(new java.awt.Color(51, 255, 102));
        jButton22.setText("•");
        ...
        jButton23.setForeground(new java.awt.Color(51, 255, 102));
        jButton23.setText("=");
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        int disc = jTextField1.getText().length();
        int bombs = jTextField1.getText().length() - 1;
        String khen;
        
        if(disc > 0)
        {
            StringBuilder likod = new StringBuilder(jTextField1.getText());
            likod.deleteCharAt(bombs);
            khen = likod.toString();
            jTextField1.setText(khen);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NoblezaCalculator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NoblezaCalculator().setVisible(true);
            }
        });
    }
